...
![ARIMA Model Specs](images/arima_specs.png){width=35%}
![ARIMA Model Parameters](images/arima_coeffs.png){width=35%}
...
Three separate models were built for comparison with a training split of 2 years. The ARIMA model has the lowest RMSE but also has the lowest ME by a large margin, indicating less drastic mistakes than either of the other models
